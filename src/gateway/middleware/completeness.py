...
async def completeness_middleware(request: Request, call_next) -> Response:
    ...
    if request.url.path in ("/", "/health", "/metrics", "/v1/models") or request.url.path.startswith(("/lineage", "/v1/lineage", "/v1/control", "/v1/attestation-proofs", "/v1/policies", "/v1/compliance")):
